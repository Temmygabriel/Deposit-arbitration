...
export default function Home() {
  ...
  const reset = useCallback(() => {
    ...
    setDisputeStatus("idle"); setStatusChecking(false); setCheckResult(null);
              ...
              <>
                <div className="poh-form-hdr">
                  ...
                  <p className="poh-form-sub">
                    {knownRole ? `The ${otherLabel} hasn't responded yet. Share the ID below.` : "The other party hasn't responded yet."}
                  </p>
                </div>
                <div className="poh-card">
